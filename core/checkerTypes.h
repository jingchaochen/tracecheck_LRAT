...
#ifndef traceCheck_SolverTypes_h
#define traceCheck_SolverTypes_h
...
#define l_True  (traceCheck::lbool((uint8_t)0)) // gcc does not do constant propagation if these are real constants.
#define l_False (traceCheck::lbool((uint8_t)1))
#define l_Undef (traceCheck::lbool((uint8_t)2))
